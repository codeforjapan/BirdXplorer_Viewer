  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <span className="aui-attachment-preview-trigger cursor-zoom-in">
            ...
            <TooltipTrigger asChild>
              ...
              >
                ...
                {isUploading && (
                  <div
                    aria-hidden="true"
                    className="aui-attachment-tile-uploading animate-in fade-in-0 absolute inset-0 flex items-center justify-center bg-background/60 backdrop-blur-[2px] motion-reduce:animate-none"
                  >
                ...
                {isError && (
                  <div
                    aria-hidden="true"
                    className="aui-attachment-tile-error animate-in fade-in-0 absolute inset-0 flex items-center justify-center bg-background/70 backdrop-blur-[2px] motion-reduce:animate-none"
                  >
