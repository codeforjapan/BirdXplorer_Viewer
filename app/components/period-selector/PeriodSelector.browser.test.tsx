...
describe("PeriodSelector", () => {
  ...
  it("should render with custom period options", async () => {
    const customOptions = [
  ...
  it("should render with 1week value", async () => {
    const { container } = await render(
  ...
  it("should render with 3months value", async () => {
    const { container } = await render(
  ...
  it("should render with 6months value", async () => {
    const { container } = await render(
  ...
  it("should render with 1year value", async () => {
    const { container } = await render(
